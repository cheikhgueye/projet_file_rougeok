...
class Proprietaire extends \KEURGUI\immoBundle\Entity\Proprietaire implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Proprietaire' . "\0" . 'id', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Proprietaire' . "\0" . 'numpiece', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Proprietaire' . "\0" . 'nomcomplet', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Proprietaire' . "\0" . 'adresse', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Proprietaire' . "\0" . 'tel', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Proprietaire' . "\0" . 'email', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Proprietaire' . "\0" . 'comptebancaire', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Proprietaire' . "\0" . 'prixPropritaire'];
        }
