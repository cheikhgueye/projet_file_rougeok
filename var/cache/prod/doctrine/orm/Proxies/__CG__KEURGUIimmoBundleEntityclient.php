 ...
 */
class client extends \KEURGUI\immoBundle\Entity\client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\client' . "\0" . 'id', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\client' . "\0" . 'numpiece', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\client' . "\0" . 'nomComplet', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\client' . "\0" . 'tel', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\client' . "\0" . 'adresse', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\client' . "\0" . 'email', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\client' . "\0" . 'password'];
        }
