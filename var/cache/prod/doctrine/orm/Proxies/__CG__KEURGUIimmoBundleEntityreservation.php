 ...
 */
class reservation extends \KEURGUI\immoBundle\Entity\reservation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\reservation' . "\0" . 'id', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\reservation' . "\0" . 'date', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\reservation' . "\0" . 'bien', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\reservation' . "\0" . 'client', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\reservation' . "\0" . 'etat'];
        }
