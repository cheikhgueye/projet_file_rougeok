 ...
 */
class CHERCHE extends \KEURGUI\immoBundle\Entity\CHERCHE implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\CHERCHE' . "\0" . 'id', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\CHERCHE' . "\0" . 'type', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\CHERCHE' . "\0" . 'localite', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\CHERCHE' . "\0" . 'prix', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\CHERCHE' . "\0" . 'localites', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\CHERCHE' . "\0" . 'types'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CHERCHE $proxy) {
