 ...
 */
class Paiement extends \KEURGUI\immoBundle\Entity\Paiement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Paiement' . "\0" . 'id', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Paiement' . "\0" . 'datePaiement', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Paiement' . "\0" . 'montant', '' . "\0" . 'KEURGUI\\immoBundle\\Entity\\Paiement' . "\0" . 'contrat'];
        }
