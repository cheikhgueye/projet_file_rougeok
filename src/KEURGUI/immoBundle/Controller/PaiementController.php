...
class PaiementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $paiements = $em->getRepository('KEURGUIimmoBundle:Paiement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('KEURGUI\immoBundle\Form\PaiementType', $paiement);
    ...
    {
        $deleteForm = $this->createDeleteForm($paiement);
        $editForm = $this->createForm('KEURGUI\immoBundle\Form\PaiementType', $paiement);
